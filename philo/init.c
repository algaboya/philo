...
/*   Updated: 2025/01/26 04:41:28 by algaboya         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	init_data(t_data *data)
{
    ...
    if (mutex_ident(&data->ready_mtx, INIT) != 0
        || mutex_ident(&data->time_mtx, INIT) != 0
        || mutex_ident(&data->die_mtx, INIT) != 0
        || mutex_ident(&data->get_mtx, INIT) != 0)
        return (EXIT_FAILURE);
