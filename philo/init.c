...
/*   Updated: 2025/01/31 03:24:15 by algaboya         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int    philo_init(t_data *data)
{
    ...
    while (i < data->nbr_of_philos)
    {
        ...
        //     data->philos->second_fork = &data->forks[(i + 1) % data->nbr_of_philos];   
        // }
        // else
	    // {
	    // 	data->philos->first_fork = &data->forks[(i + 1) % data->nbr_of_philos];
	    // 	data->philos->second_fork = &data->forks[i];
	    // }
